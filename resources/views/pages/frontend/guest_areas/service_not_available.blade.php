        ...
        <div class="container max-w-5xl mx-auto m-8">
            ...
            <div class="bg-white p-3">
                <div x-data="{ show: true }" x-show="show"
                     class="flex justify-between items-center bg-blue-200 relative text-blue-600 py-3 px-3 rounded-lg">
                    <div>
                        <span class="font-semibold text-blue-700">Service Not Available!!!</span><br/>
                        {{$public_user_not_found_message}}
                    </div>
                </div>
                <br/>
                <a href="{{route('welcome')}}" style="text-decoration: none;cursor: pointer;"
