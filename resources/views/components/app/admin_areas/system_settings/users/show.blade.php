...
@section('content')
    ...
    <div class="container">
        <div class="tw-bg-white tw-p-6 tw-rounded-lg tw-shadow-lg">
            <h2 class="tw-text-2xl tw-font-bold tw-mb-2 tw-text-blue-600 tw-float-left">User Details</h2>
            ...
            <div class="table-responsive tw-bg-gradient-to-r tw-from-green-100 tw-to-blue-200 tw-rounded">
                <div class="container">
                        ...
                        <tr class="  tw-text-sm tw-leading-normal">
                            ...
                            <span
                                class="{{($user->last_login_at)?'tw-bg-blue-200 tw-text-blue-600 tw-py-1 tw-px-3 tw-rounded-full tw-text-xs ':'tw-bg-purple-200 tw-text-purple-600 tw-py-1 tw-px-3 tw-rounded-full tw-text-xs'}}">
                                    {{$user->last_login_at?date('M j, Y',strtotime($user->last_login_at)):'No System Login History Found Yet'}}</span>
                            </td>
                        </tr>
                        <tr class="tw-text-sm tw-leading-normal">
