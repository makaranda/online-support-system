...
@section('title','Blantyre Call Report')
    ...
    <div class="container-fluid tw-px-10">
                    ...
                    <div class="col-sm-12">
                        <div class="card table-responsive tw-rounded-lg">
                            <div class="card-body tw-bg-white">
                                <form action="{{route('reports.lilongwe_call_report')}}" method="GET">
                                    <div class="row">
                                        <div class="col-sm-10">
                                        ...
                                        <div class="col-sm-1">
                                            <div class="form-group">
                                                <label>Re-Load</label>
                                                <a href="{{route('reports.lilongwe_call_report')}}" id="btn_clear_search" class="btn btn-sm btn-block tw-bg-gray-700 text-white"><i class="fa fa-redo"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
        ...
        <main class="tw-h-full tw-overflow-y-auto tw-bg-gray-100 tw-rounded-lg">
            <div class="tw-container tw-px-6 tw-mx-auto tw-grid tw-rounded-lg tw-mt-5 tw-mb-5">
                ...
                >
                    Call Report for Branch - Lilongwe (LLW)
                </h2>
