...
@section('title','Customer Type Wise Ticket Report')
...
{{--        </main>--}}
        ...
        <main class="tw-h-full tw-overflow-y-auto tw-bg-gray-100 tw-rounded-lg">
            <div class="tw-container tw-px-6 tw-mx-auto tw-grid tw-rounded-lg tw-mt-5 tw-mb-5">
                ...
                >
                    Customer Type Wise Ticket Report
                </h2>
                                        ...
                                        <table class="tw-min-w-max tw-w-full tw-table-auto">
                                            <thead>
                                                <tr class="tw-bg-gray-200 tw-text-gray-600 tw-uppercase tw-text-sm tw-leading-normal">
                                                    <th class="tw-py-3 tw-px-6 tw-text-left">Customer Type</th>
                                                    <th class="tw-py-3 tw-px-6 tw-text-center">TICKET cOUNT</th>
                                                </tr>
                                            </thead>
                                            <tbody class="tw-text-gray-600 tw-text-sm tw-font-light tw-bg-white">
                                            @forelse($data as $key => $data_item)
                                                <tr class="tw-border-b tw-border-gray-200 {{$data_item['color']}}">
                                                    <td class="tw-py-3 tw-px-6 tw-text-left tw-whitespace-nowrap ">
                                                        <div class="tw-flex tw-items-center">
                                                            <span class="tw-font-medium tw-font-bold">{{Str::upper($key)}}</span>
                                                        </div>
                                                    </td>
                                                    <td class="tw-py-3 tw-px-6 tw-text-center tw-whitespace-nowrap {{$data_item['color']}} tw-font-medium tw-font-bold">
                                                        <span class="tw-font-medium tw-font-bold">{{$data_item['count']}}</span>
                                                    </td>
                                                </tr>
                                            @empty
                                                <tr>
                                                    <td colspan="2" class="tw-py-3 tw-px-6 tw-text-center">No Data Found Yet</td>
                                                </tr>
                                            @endforelse
                                            </tbody>
                                            <tfoot>
