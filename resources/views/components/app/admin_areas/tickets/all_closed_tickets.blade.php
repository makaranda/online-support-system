                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="tw-grid tw-gap-6 tw-mb-8 md:tw-grid-cols-2 xl:tw-grid-cols-3">
                            <!-- Card -->
                            <a href="{{route('tickets.create')}}" style="cursor: pointer;text-decoration: none"
                            ...
                            <a href="{{route('tickets.recent_tickets')}}" style="cursor: pointer;text-decoration: none"
                               class="tw-text-white hover:tw-text-green-400">
                                <div class="tw-flex tw-items-center tw-p-2 tw-bg-white tw-rounded-lg tw-shadow-xs">
                                    <div class="tw-p-3 tw-mr-4 tw-bg-black tw-rounded-full">
                            ...
                            <a href="{{route('tickets.opened_tickets')}}" style="cursor: pointer;text-decoration: none"
                               class="tw-text-white hover:tw-text-green-400">
                                <div class="tw-flex tw-items-center tw-p-2 tw-bg-white tw-rounded-lg tw-shadow-xs">
                                    <div class="tw-p-3 tw-mr-4 tw-bg-black tw-rounded-full">
                            ...
                            <a href="{{route('tickets.assigned_tickets')}}"
                            ...
                            <a href="{{route('call_open_tickets.index')}}" style="cursor: pointer;text-decoration: none"
                               class="tw-text-white hover:tw-text-green-400">
                                <div class="tw-flex tw-items-center tw-p-2 tw-bg-white tw-rounded-lg tw-shadow-xs">
                                    <div class="tw-p-3 tw-mr-4 tw-bg-black tw-rounded-full">
                            ...
                            <a href="{{route('tickets.closed_tickets')}}" style="cursor: pointer;text-decoration: none"
                    ...
                    <div class="col-sm-12">
                        <div class="card table-responsive tw-rounded-lg">
                            <div class="card-body tw-bg-white">
                                <form action="{{route('tickets.closed_tickets')}}" method="GET">
                                    <div class="row">
                                        <div class="col-sm-3">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control form-control-sm" name="assigned_to" id="assigned_to" style="width: 100%;">
                                                    ...
                                                    <option value="0" >Not Assignedr</option>
                                                    @foreach($active_users as $active_user)
                                                        @if(
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>&nbsp;</label>
                                                <a href="{{route('tickets.closed_tickets')}}" id="btn_search" class="btn btn-sm btn-block tw-bg-blue-500 text-white"><i class="fa fa-undo" title="Re-Load Recent Tickets"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="tw-w-full tw-mb-12 tw-rounded">
                                <div class="tw-bg-white tw-shadow-md my-6">
                                    <table class="tw-w-full tw-table-auto table">
                                        ...
                                        @forelse($closed_tickets as $ticket)
                        ...
                        <div class="tw-shadow-md tw-bg-gray-100">
                            @include('components.pagination', ['items' => $closed_tickets])
                        </div>
                    </div>
                </div>
