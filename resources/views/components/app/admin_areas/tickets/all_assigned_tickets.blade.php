...
@section('content')
    <div class="container-fluid tw-px-10">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="tw-grid tw-gap-6 tw-mb-8 md:tw-grid-cols-2 xl:tw-grid-cols-3">
                            ...
                            <a href="{{route('tickets.assigned_tickets')}}" style="cursor: pointer;text-decoration: none" class="tw-text-green-400 hover:tw-text-white">
                                <div class="tw-flex tw-items-center tw-p-2 tw-bg-white tw-rounded-lg tw-shadow-xs">
                                    <div class="tw-p-3 tw-mr-4 tw-bg-black tw-rounded-full">
        ...
        <main class="tw-h-full tw-overflow-y-auto tw-bg-gray-100 tw-rounded-lg">
            <div class="tw-container tw-px-6 tw-mx-auto tw-grid tw-rounded-lg">
                <h2
                    class="tw-my-3 tw-text-2xl tw-font-semibold tw-text-gray-700 dark:tw-text-gray-200"
                >
                    Assigned Tickets Details
                </h2>
                <div class="row ">
                    <div class="col-sm-12">
                        <div class="card table-responsive tw-rounded-lg">
                            <div class="card-body tw-bg-white">
                                <form action="{{route('tickets.assigned_tickets')}}" method="GET">
                                    <div class="row">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label>&nbsp;</label>
                                                <a href="{{route('tickets.assigned_tickets')}}" id="btn_search" class="btn btn-sm btn-block tw-bg-blue-500 text-white"><i class="fa fa-undo" title="Re-Load Recent Tickets"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                ...
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="tw-w-full tw-mb-12 tw-rounded">
                                <div class="tw-bg-white tw-shadow-md my-6">
                                    <table class="tw-w-full tw-table-auto table">
                                        ...
                                        @forelse($assigned_tickets as $ticket)
                                            ...
                                            <tr class="tw-border-b tw-border-gray-200 hover:tw-bg-gray-100">
                                                ...
                                                <td class="tw-py-3 tw-px-6 tw-text-left">
                                                    <div class="tw-flex tw-items-left">
                                                        <span>{{(strlen($ticket->subject)>30)?substr($ticket->subject,1,50).'...':$ticket->subject}}</span>
                                                    </div>
                                                    <div class="tw-flex tw-items-left">
                                                ...
                                                <td class="tw-py-3 tw-px-6 tw-text-left">
                                                    <div class="tw-flex tw-items-left">
                                                        <span>{{(strlen($ticket->customer)>50?substr($ticket->customer,1,30).'...':$ticket->customer)}}</span>
                                                    </div>
                                                    <div class="tw-flex tw-items-left">
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="5" class="tw-py-3 tw-px-6 tw-text-center">Recently Added Tickets Not Found Yet</td>
                                            </tr>
                                        @endforelse
                                        </tbody>
                                        <tfoot>
                        ...
                        <div class="tw-shadow-md tw-bg-gray-100">
                            @include('components.pagination', ['items' => $assigned_tickets])
                        </div>
                    </div>
                </div>
