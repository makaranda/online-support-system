            ...
            <div class="tw-bg-white tw-p-6 tw-rounded-lg tw-shadow-lg">
                <div class="card tw-border-white tw-rounded">
                    <div class="card-header tw-bg-white">
                        <h2 class="tw-text-2xl tw-font-bold tw-mb-2 tw-text-gray-800 tw-float-left">Please fill in the form below to open a new ticket.</h2>
                    ...
                    <div class="card-body">
                        <form action="{{route('tickets.store')}}" method="POST" id="form_create" class="form_create">
                            @csrf
                            @if($crm_cdr_data !== null)
                            ...
                            <div class="card tw-mb-5 tw-border-white">
                                ...
                                <div class="card-body">
                                    <div class="row" style="width:100%;">
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                ...
                                                <input type="text" autocomplete="off"
                                                       ...
                                                       id="w_account_no" name="w_account_no" placeholder="Enter W-Account Number" value="{{old('w_account_no')}}"/>
                                                <x-invalid_feedback field="w_account_no"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Customer Name <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                <input type="text" required="" autocomplete="off" id="customer_name"
                                                       class="form-control form-control-sm @error('customer_name') tw-border-red-600 @enderror"
                                                       name="customer_name" placeholder="Enter Customer Name" value="{{old('customer_name')}}"/>
                                                <x-invalid_feedback field="customer_name"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Service Branch <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                <select required="" class="form-control form-control-sm @error('service_branch') tw-border-red-600 @enderror"
                                                    ...
                                                    @foreach($service_branches as $branch)
                                                        ...
                                                        @elseif(\Illuminate\Support\Facades\Auth::user()->branch_id == $branch->id)
                                                            <option selected=""
                                                                    value="{{$branch->id}}">{{$branch->name.' ('.$branch->code.')'}}</option>
                                                        @else
                                                            <option
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Service Type <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                <select required=""
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                ...
                                                <input type="text" autocomplete="off"
                                                       ...
                                                       name="telephone_no" placeholder="Enter Telephone No" value="{{old('telephone_no')}}"/>
                                                <x-invalid_feedback field="telephone_no"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Cell Phone No <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                <input type="text" required="" autocomplete="off"
                                                       class="form-control form-control-sm @error('cell_phone_no') tw-border-red-600 @enderror"
                                                       name="cell_phone_no" placeholder="Enter Cell Phone No" value="{{old('cell_phone_no')}}"/>
                                                <x-invalid_feedback field="cell_phone_no"/>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Priority <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                <select required="" class="form-control form-control-sm @error('priority') tw-border-red-600 @enderror" name="priority" >
                                                    <option selected="" disabled="">Select Priority</option>
                                                    @foreach($priorities as $key => $priority)
                                                        @if($priority[0] === 'Normal')
                                                            <option selected=""
                                                                    value="{{$priority[0]}}" selected="" class="{{$priority[1]}}">{{$priority[0]}}</option>
                                                        @elseif(old('priority') === $priority[0])
                                                            <option selected=""
                                                                    value="{{$priority[0]}}" selected="" class="{{$priority[1]}}">{{$priority[0]}}</option>
                                                        @else
                                                            <option
                                                                value="{{$priority[0]}}" class="{{$priority[1]}}">{{$priority[0]}}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                ...
                                                <input type="email" autocomplete="off"
                                                       class="form-control form-control-sm @error('email') tw-border-red-600 @enderror" id="email"
                                    ...
                                    <div class="row" style="width:100%;">
                                        <div class="col-sm-3">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Customer Type <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                ...
                                                <x-invalid_feedback field="customer_type"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row" style="width:100%;">
                                        <div class="col-sm-12">
                                            <div class="form-group p-2 tw-bg-yellow-200 tw-text-yellow-700 tw-rounded-lg">
                                                ...
                                                &nbsp;Enter valid Email Addresses, Invalid Email Addresses will be removed when save details!!!
                                            </div>
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label for="email_cc_addresses">Email CC Addresses - Type Email/s and Hit Enter </label>
                                                <select class="form-control @error('email_cc[]') tw-border-red-600 @enderror"
                                                        multiple="multiple" id="email_cc_addresses" name="email_cc[]"></select>
                            ...
                            <div class="card tw-border-white tw-bg-white tw-border-rounded">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Ticket Subject (Header) <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                                <input type="text" autocomplete="off"
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                <label>Ticket Message (Body) <i class="fa fa-asterisk tw-text-pink-700 tw-text-xs"></i></label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group form-group-sm tw-ml-3">
                                                ...
                                                <select
                                                    class="select2 form-control form-control-sm @error('assign_user') tw-border-red-600 @enderror "
                                                    style="width: 100%;"
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function(){
            //Autocomplete search by w_account_no and fill fields
            ...
            //Autocomplete search by company name/customer first or last name and fill fields
            $( "#customer_name" ).autocomplete({
                ...
                select: function (event, ui) {
                    ...
                    $('#service_branch').val(ui.item.branch);
                    $('#service_type').val(ui.item.service);
                    $('#customer_type').val(ui.item.cus_type);
                    loadBranchUsers(ui.item.branch);
                    return false;
                }
            });
